...
public:
    ...
    static vector<vector<double>> subMatrix_step(const vector<vector<double>> &A,int r, int r_step, int r_end, int c,int c_step, int c_end);
    ...
    static double matrix_sum (const vector<vector<double>> &A);
